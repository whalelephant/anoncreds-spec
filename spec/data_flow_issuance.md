...
* `key_correctness_proof`: The Fiat-Shamir transformation challenge value in the non-interactive mode of [Schnorr Protocol](https://d-nb.info/1156214580/34) made by the [[ref: issuer]] for the proof of knowledge of the private key to the [[ref: Credential Definition]]. This is verified by the [[ref: prover]] to form the [[ref: Credential Request]].
